...
void test_yolo(char *cfgfile, char *weightfile, char *filename, float thresh)
{
    ...
    while(1){
        ...
        draw_detections(im, dets, l.side*l.side*l.n, thresh, voc_names, alphabet, 2);
...
void run_yolo(int argc, char **argv)
{
    ...
    else if(0==strcmp(argv[2], "demo")) demo(cfg, weights, thresh, cam_index, filename, voc_names, 2, frame_skip, prefix, avg, .5, 0,0,0,0);
}
